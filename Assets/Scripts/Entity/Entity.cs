...
public class Entity : MonoBehaviour
{
    ...
    /// <summary>
    /// GamaManager의 Entities 리스트에 자신을 추가한다.
    /// </summary>
    ...
    /// <summary>
    /// 인자로 받은 방향(Vector2)으로 엔티티를 이동시킨다.
    /// </summary>
...
public class EntityState
{
    ...
    public EntityState(EntityType type = EntityType.Other, string name = "", bool blocksMovement = false,
